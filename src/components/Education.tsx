...
import ikpi from '../assets/ikpi.png';
...
const educationData: EducationItem[] = [
  {
    ...
    degree: 'Bachelor\'s Degree in Computerized Accounting System',
    period: 'Sept 2005 - Oct 2009',
    description: 'Specialized in Product Research. Completed a thesis on the Evaluation of Front Office System Information.',
    gpa: '3.23/4.00',
    logo: binusLogo,
  },
  {
    ...
    description: 'Completed RevoU Full-stack Data Analytics program, gaining hands-on experience in statistics, SQL, Python, and Tableau through real projects to generate actionable insights.',
    logo: revouLogo, 
  },
];
...
const certificationsData: Certification[] = [
  {
    ...
    year: 'March 2026',
    issuer: 'RevoU',
    url: 'https://certificates.revou.tech/?id=FSDA-2026-03-173760096973&name=Andy%2BGiovanni'
  },
  {
    name: 'Brevet Pajak AB Certification',
    year: 'Sep 2016',
    issuer: 'IKPI PT. Cipta Tunas Edukasi',
    url: 'https://drive.google.com/file/d/1RuvCqUmppwuMmL8r-oviv-O2LkvzFraM/view?usp=drive_link'
  },
  {
    name: 'Data Analytics Mini Course',
    year: 'Oct 2025',
    issuer: 'RevoU',
    url: 'https://drive.google.com/file/d/1kYuHZwnGIBOjUH-oqVREVvLWWp3sNSgP/view?usp=drive_link'
  },
];
...
const getLogo = (institution: string) => {
  ...
  if (institution.includes('Bachelor\'s Degree in Computerized Accounting System')) return binusLogo;
  return null;
};
...
const getCertLogo = (issuer: string) => {
  switch (issuer) {
    case 'RevoU': return revouLogo;
    case 'IKPI': return ikpi;
    default: return null;
  }
};
                ...
                >
                  <div className="p-3 rounded-full bg-[#9d6738]/20 w-fit mx-auto mb-3">
                    {getCertLogo(cert.issuer) ? (
                      <img
                        src={getCertLogo(cert.issuer) || undefined}
