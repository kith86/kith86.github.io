        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              <motion.div whileHover={{ x: 3 }} className="flex items-center">
               ...
               <a 
              href="mailto:kithgiov86@gmail.com" 
              className="hover:text-[#d18a4c] transition-colors"
                >
              kithgiov86@gmail.com
                </a>
              </motion.div>
              <motion.div whileHover={{ x: 3 }} className="flex items-center">
                <MapPin className="w-5 h-5 text-[#d18a4c] mr-2" />
                <span>Pamulang, South Tangerang</span>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex space-x-3">
              <motion.a
                href="https://www.linkedin.com/in/andy-giovanni-b72744151/"
                target="_blank"
              ...
              <motion.a
              href="https://wa.me/6281806130094" // <-- Ganti dengan nomor WA kamu
              target="_blank"
              rel="noopener noreferrer"
                  whileHover={{
                  scale: 1.1,
                  y: -3,
                  boxShadow: '0px 0px 12px rgba(34, 197, 94, 0.7)', // Cahaya warna hijau
                }}
  whileTap={{ scale: 0.95 }}
  className="p-2 bg-gray-800 rounded-full transition duration-300 hover:bg-green-500"
  aria-label="WhatsApp"
>
  <FaWhatsapp className="w-5 h-5" />
        ...
        >
          ...
          <p className="text-gray-400 mt-12 text-sm">© 2026 Andy Giovanni. All rights reserved.</p>
