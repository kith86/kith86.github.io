...
const Hero: React.FC<HeroProps> = ({ scrollToSection }) => {
  ...
  const name = "Hi, My Name is Andy Giovanni";
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-center w-full max-w-5xl gap-10">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            >
              Blending hands-on experience with growing analytical skills to transform data into actionable insights.
            </motion.p>
